...
/**
 * This class represents the AggregateStatsDirective for processing aggregates
...
public class AggregateStatsDirective implements Directive {
    ...
    public void initialize(Arguments args) throws DirectiveParseException {
        ...
        if (!args.contains("size_column")) {
            throw new DirectiveParseException("Missing required arguments: size_column");
        }
        if (!args.contains("time_column")) {
            throw new DirectiveParseException("Missing required arguments: time_column");
        }
        if (!args.contains("size_output")) {
            throw new DirectiveParseException("Missing required arguments: size_output");
        }
        if (!args.contains("time_output")) {
            throw new DirectiveParseException("Missing required arguments: time_output");
        }
    ...
    private double convertNanos(long nanos, String unit) {
        switch (unit.toLowerCase()) {
            ...
            case "d":
                return nanos / (86400.0 * 1_000_000_000);
            default:
