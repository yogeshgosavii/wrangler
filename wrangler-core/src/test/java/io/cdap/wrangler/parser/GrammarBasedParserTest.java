...
public class GrammarBasedParserTest {
    ...
    private RecipeCompiler recipeCompiler;
    ...
    private boolean hasErrors(CompileStatus status) {
    ...
    public void testValidAggregateStats() throws Exception {
        String recipe = "aggregate-stats :col1 :col2 out1 out2";
        CompileStatus status = recipeCompiler.compile(recipe);
        assertFalse("Should compile successfully", hasErrors(status));
    }
}
